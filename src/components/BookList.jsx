...
export default function BookList() {
  ...
  useEffect(() => {
    axios
      .get("https://node57135-thitirat-noderest.proen.app.ruk-com.cloud/books")
      .then((response) => {
  ...
  const viewBook = (id) => {
    axios
      .get(`https://node57135-thitirat-noderest.proen.app.ruk-com.cloud/books/${id}`)
      .then((response) => {
  ...
  const deleteBook = (id) => {
    axios
      .delete(`https://node57135-thitirat-noderest.proen.app.ruk-com.cloud/books/${id}`)
      .then(() => {
